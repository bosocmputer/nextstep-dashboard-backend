...
source_of_truth: [cmd/api/main.go, cmd/worker/main.go, api/openapi.yaml, internal/report/catalog.go]
...
- Scheduler, report, notification preparation, LINE delivery, retention, quota, and heartbeat loops are separate worker responsibilities.
