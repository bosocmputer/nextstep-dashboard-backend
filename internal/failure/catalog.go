...
var knownCodes = []string{
	...
	"DELIVERY_REFERENCE_FAILED", "TENANT_INACTIVE", "RECIPIENT_INACTIVE",
	...
	"BACKUP_OFFSITE_NOT_CONFIGURED", "BACKUP_STALE", "RESTORE_VERIFICATION_STALE",
	"HOST_DISK_WARNING", "HOST_MEMORY_WARNING", "HOST_PROBE_INVALID", "HOST_PROBE_UNAVAILABLE",
	"HOST_PROBE_STALE", "HOST_TIME_UNSYNCHRONIZED", "SENTINEL_HEARTBEAT_INVALID", "SENTINEL_HEARTBEAT_STALE",
	"API_CONTAINER_UNHEALTHY", "FRONTEND_CONTAINER_UNHEALTHY", "POSTGRES_CONTAINER_UNHEALTHY",
	"SENTINEL_CONTAINER_UNHEALTHY", "WORKER_CONTAINER_UNHEALTHY",
}
...
func isRecognizedCode(code string) bool {
	...
	if strings.HasPrefix(upper, "SML_HTTP_") || strings.HasPrefix(upper, "CONTAINER_") || strings.HasPrefix(upper, "TELEGRAM_") {
		return true
	}
...
func classify(code string) (Category, Stage) {
	...
	case "DATABASE_UNAVAILABLE", "NEXTSTEP_CONTAINER_UNHEALTHY", "BACKUP_CHECKSUM_INVALID", "BACKUP_OVERDUE", "RESTORE_VERIFICATION_OVERDUE",
		"HOST_PROBE_INVALID", "HOST_PROBE_UNAVAILABLE", "HOST_PROBE_STALE", "HOST_TIME_UNSYNCHRONIZED",
		"SENTINEL_HEARTBEAT_INVALID", "SENTINEL_HEARTBEAT_STALE", "API_CONTAINER_UNHEALTHY",
		"FRONTEND_CONTAINER_UNHEALTHY", "POSTGRES_CONTAINER_UNHEALTHY", "SENTINEL_CONTAINER_UNHEALTHY", "WORKER_CONTAINER_UNHEALTHY":
	...
	default:
		...
		if strings.HasPrefix(upper, "CONTAINER_") || strings.HasPrefix(upper, "TELEGRAM_") {
			return CategoryPlatform, StagePlatformCheck
		}
		return CategoryPlatform, StagePlatformCheck
	}
